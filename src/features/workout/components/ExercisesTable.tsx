...
const ExercisesTable = ({ exercises, loading = false, onEdit, onDelete }: Props) => (
  <div className="border border-[#222222] rounded-[8px] overflow-hidden">
    <div className="overflow-x-auto">
      {/* El min-w solo aplica desde md, que es cuando aparece la columna
          Descripción. Abajo de eso las tres columnas visibles entran solas. */}
            ...
            : exercises.map((exercise) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span className="inline-flex items-center px-2 py-0.5 rounded-[4px] text-xs font-medium bg-[#222222] text-white whitespace-nowrap">
