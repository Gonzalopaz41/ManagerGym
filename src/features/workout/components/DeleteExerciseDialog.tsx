...
import { deleteExerciseThunk } from '../slice/workout.thunk';
...
const DeleteExerciseDialog = ({ open, onClose, exercise }: Props) => {
  ...
  const handleConfirm = async () => {
    ...
    const action = await dispatch(deleteExerciseThunk(exercise.id));
    setSubmitting(false);
